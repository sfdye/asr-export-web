...
const en = {
  ...
  docsInCats: '{total} documents in {count} categories. Everything is bundled into a single zip.',
  ...
  expiredHint: 'If it says “not found or expired”, the export or its zip passed the 24-hour mark.',
  backToDocs: 'Back to my documents',
  startingExport: 'Starting your export…',
  preparingZip: 'Preparing your zip…',
  ...
  zipReady: 'Your zip is ready',
  doneDocs: '{n} of {total} documents',
  downloadZip: 'Download zip',
  deletedAfter24h: 'The download link works for 24 hours — after that your zip is deleted from our server.',
...
const zh: Record<TKey, string> = {
  ...
  footer: '下载文件在我们服务器上生成，24 小时后删除，绝不对外共享。我们不会存储您的密码。',

  loginTitle: '登录 Habitap',
  loginHint: '使用您的 Habitap 账号（即您平时查看 ASR 文件的应用）。新设备登录会收到一次性邮件验证码。',
  email: '邮箱',
  password: '密码',
  signingIn: '登录中…',
  signIn: '登录',
  ...
  signOut: '退出登录',
  yourDocuments: '您的文件',
  docsInCats: '共 {total} 份文件，分为 {count} 个类别。所有文件将打包为一个 zip。',
  selectAll: '全选',
  clear: '清空',
  nDocuments: '{n} 份文件',
  nDocumentsOne: '{n} 份文件',
  ...
  exportProblem: '导出问题',
  lostTrack: '无法跟踪导出进度',
  expiredHint: '如提示“不存在或已过期”，表示该导出或其 zip 已超过 24 小时。',
  backToDocs: '返回我的文件',
  startingExport: '正在启动导出…',
  preparingZip: '正在准备 zip…',
  keepOpen: '请保持此页面打开，或收藏书签稍后回来查看（24 小时内有效）。',
  ...
  downloadZip: '下载 zip',
  deletedAfter24h: '下载链接 24 小时内有效，之后您的 zip 会从我们的服务器上删除。',
  couldNotFetch: '{n} 份文件无法获取',
  couldNotFetchOne: '{n} 份文件无法获取',
